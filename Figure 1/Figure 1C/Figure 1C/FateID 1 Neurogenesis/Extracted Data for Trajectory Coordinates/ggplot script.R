...
OLsNB <- ggplot(plotdata, aes(x = Axis1, y = Axis2)) +
  ...
  theme(line = element_blank(),
        text = element_blank(),
        title = element_blank()) + geom_line(aes(x = t11V1, y = t11V2),size=1.5, linetype="dotted", colour = "black") + geom_line(aes(x = t13V1, y = t13V2),size=2, linetype="solid", colour = "black")
print(OLsNB)
