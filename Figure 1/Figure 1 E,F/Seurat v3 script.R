...
scex <- read.csv("sce1062cells_unNorm.csv", header = TRUE, row.names = 1)
...
head(x = Idents(object = scex), 13)

# Relevel object@ident
###### I RAN these 2 and they worked!!! 
scex$orig.ident <- factor(x = scex$orig.ident, levels = c("NB", "MOL", "OPC", "OLTAP", "TAP", "OLaNSC", "aNSC", "OLpNSC", "pNSC", "OLqNSCII", "qNSCII", "OLqNSCI", "qNSCI"))
...
DimPlot(object = scex, reduction = "tsne", pt.size = 2)
